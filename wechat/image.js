...
module.exports = function(image, req, res, next){
  ...
  if (fromOpenID === 'o5Lr2t1c6b0JV0xidlxbClJa56s4'){
 		...
 		download(PicUrl,function(err,img_guid){
          ...
          content = content + '\n\r' + '1、书法绘画 \r\n http://' + config.domain + '/shf/editshfinfo?img_guid=' + img_guid;
          content = content + '\n\r' + '2、添加到我的足迹 \r\n http://' + config.domain + '/footer/addimage?img_guid=' + img_guid;
          content = content + '\n\r' + '3、添加读书笔记 \r\n http://' + config.domain + '/books/notes/addimage?img_guid=' + img_guid;
          content = content + '\n\r' + '4、增加图片的说明备注 \r\n http://' + config.domain + '/images/addinfo?img_guid=' + img_guid;
          content = content + '\n\r' + '5、增加到我的花销 \r\n http://' + config.domain + '/cost/addimage?img_guid=' + img_guid;
          content = content + '\n\r' + '6、上传错了现在删除掉 \r\n http://' + config.domain + '/images/del/' + img_guid;
